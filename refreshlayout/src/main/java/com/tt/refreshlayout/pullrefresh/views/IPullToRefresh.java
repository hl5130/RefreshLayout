 ...
 *******************************************************************************/
package com.tt.refreshlayout.pullrefresh.views;

import android.view.View;
import android.view.animation.Interpolator;

import com.tt.refreshlayout.pullrefresh.views.PullToRefreshBase.Mode;
import com.tt.refreshlayout.pullrefresh.views.PullToRefreshBase.OnPullEventListener;
import com.tt.refreshlayout.pullrefresh.views.PullToRefreshBase.OnRefreshListener;
import com.tt.refreshlayout.pullrefresh.views.PullToRefreshBase.OnRefreshListener2;
import com.tt.refreshlayout.pullrefresh.views.PullToRefreshBase.State;
...
public interface IPullToRefresh<T extends View> {
     ...
     * 获取到正在使用的刷新模式，只有在刷新的时候才有效
     * 例如：要使用上拉加载和下拉刷新，这时使用 Mode.BOTH
     ...
     *  获取触摸事件是否被过滤。如果返回的是true，视图只能使用触摸事件，并且Y轴上的差距大于X轴的差距。
     *  这意味着，在水平滚动视图中使用使用时，视图不会被干扰
